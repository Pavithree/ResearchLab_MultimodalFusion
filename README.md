...
* MIMIC-CXR 
    ...
    * The images and radiology text reports are extracted and pre-processed. You can find the details [here](https://github.com/Pavithree/ResearchLab_MultimodalFusion/edit/main/README.md)
